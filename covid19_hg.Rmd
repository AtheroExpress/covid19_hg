...
prelim.gwas.raw <- fread(paste0(RAWDATA_loc,"/COVID19_HGI_ANA2_20200508.txt.gz"),
                         header = TRUE,
                         verbose = FALSE,
                         showProgress = TRUE)

prelim.gwas.raw5 <- fread(paste0(RAWDATA_loc,"/COVID19_HGI_ANA5_20200508.txt.gz"),
                         header = TRUE,
                         verbose = FALSE,
                         showProgress = TRUE)

prelim.gwas.raw7 <- fread(paste0(RAWDATA_loc,"/COVID19_HGI_ANA7_20200508.txt.gz"),
                         header = TRUE,
                         verbose = FALSE,
                         showProgress = TRUE)
...
prelim.gwas.raw5.hrcr11 <- merge(prelim.gwas.raw5, hrcr11.sub, 
                                            by.x = "SNP", by.y = "ALTID", 
                                            sort = FALSE, all = FALSE)

prelim.gwas.raw7.hrcr11 <- merge(prelim.gwas.raw7, hrcr11.sub, 
                                            by.x = "SNP", by.y = "ALTID", 
                                            sort = FALSE, all = FALSE)
